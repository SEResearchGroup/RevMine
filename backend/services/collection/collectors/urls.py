...
urlpatterns = [
    ...
    path('branches/', GetBranchesForRepositoryView.as_view(), name='repository-branches'),
    ...
    # Resume collection
    path('plans/<int:plan_id>/resume/', ResumeCollectionView.as_view(), name='collection-resume'),
    
    # Data cleaning and structuring
    path('plans/<int:plan_id>/cleaning-config/', DataCleaningConfigView.as_view(), name='data-cleaning-config'),
    path('plans/<int:plan_id>/apply-filters/', ApplyFiltersAndCreateCSVView.as_view(), name='apply-filters-csv'),
    
    # Collection management
    path('collections/<int:collection_id>/', CollectionStatusView.as_view(), name='collection-detail'),
    path('collections/<int:collection_id>/download/', DownloadCollectionJSONView.as_view(), name='download-collection-json'),
    path('collections/<int:collection_id>/delete/', DeleteCollectionView.as_view(), name='delete-collection'),
    
    # CleanedData (cleaning operations)
    path('collections/<int:collection_id>/cleaned-data/', CollectionCleanedDataListView.as_view(), name='collection-cleaned-data'),
    path('cleaned-data/', CreateCleanedDataView.as_view(), name='create-cleaned-data'),
    path('cleaned-data/<int:cleaned_data_id>/', CleanedDataDetailView.as_view(), name='cleaned-data-detail'),
    path('cleaned-data/<int:cleaned_data_id>/download/<str:file_type>/', DownloadCleanedDataCSVView.as_view(), name='download-cleaned-data-csv'),
