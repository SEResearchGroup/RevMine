...
class CollectionService:
    ...
    def get_or_create_collection(
        ...
        existing_collection = CollectionService._mark_stale_collections(existing_collection)
    ...
    def configure_metrics(
        ...
        logger.info(f"Metrics configured for collection {collection.id}: {selected_metrics}")
...
class CleanedDataService:
    ...
    def create_cleaned_data(
        ...
        try:
            ...
            cleaned_data.stats = CleanedDataService._calculate_stats(filtered_data, collection.platform)
