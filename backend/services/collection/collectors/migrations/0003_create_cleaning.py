    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(blank=True, help_text='Start date for cleaning filter', null=True)),
                ('end_date', models.DateField(blank=True, help_text='End date for cleaning filter', null=True)),
                ...
                ('collection', models.ForeignKey(help_text='The collection this cleaning belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='cleanings', to='collectors.collection')),
            ],
            options={
                'db_table': 'cleanings',
                'ordering': ['-created_at'],
        ...
        migrations.AddIndex(
            model_name='cleaning',
            index=models.Index(fields=['collection', 'status'], name='cleanings_collect_idx'),
        ),
    ]
