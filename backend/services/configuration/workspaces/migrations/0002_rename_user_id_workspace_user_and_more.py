...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='workspace',
            name='platform',
            field=models.CharField(choices=[('github', 'GitHub'), ('gitlab', 'GitLab.com'), ('gitlab_self', 'GitLab Self-Hosted')], max_length=20),
        ),
        migrations.AlterField(
            model_name='workspace',
            name='url',
            field=models.URLField(blank=True, help_text='Required only for GitLab self-hosted', null=True),
        ),
