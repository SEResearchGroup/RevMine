...
class Repository(models.Model):
    ...
    external_id = models.CharField(max_length=100, help_text="ID of the repo on GitHub/GitLab")
    ...
    created_at_platform = models.DateTimeField(help_text="Creation date on the platform")
    last_activity_at = models.DateTimeField(null=True, blank=True)
    
    is_active = models.BooleanField(default=True, help_text="If the repo is active for analysis")
    last_analyzed_at = models.DateTimeField(null=True, blank=True)
    imported_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    
    raw_data = models.JSONField(blank=True, null=True, help_text="Raw data from the API")
