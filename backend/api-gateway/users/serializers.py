...
class RegisterSerializer(serializers.ModelSerializer):
    password = serializers.CharField(
        write_only=True, help_text="Password (minimum 8 characters recommended)"
    )

    first_name = serializers.CharField(
        required=False, allow_blank=True, help_text="First name"
    )
    last_name = serializers.CharField(
        required=False, allow_blank=True, help_text="Last name"
    )
    position = serializers.CharField(
        required=False, allow_blank=True, help_text="Position or job title"
    )
